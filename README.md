...
Data-driven Next.js app (builds and runs) with a grounded, injection-resistant chatbot assistant.
The explainer-video pipeline is still a pilot (mocked narration + placeholder footage).
